      ...
      <div ref={mainRef} className="relative">
        ...
        <section ref={scrollTakeoverRef} className="relative h-screen w-full overflow-hidden flex items-center justify-center z-10 pt-16">
          ...
          <div className="absolute inset-0 pointer-events-none z-40">
            {/* 1. Top Left */}
            <div 
              className="takeover-hud-card absolute top-[22%] left-[5%] md:top-[28%] md:left-[6%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-5 w-full max-w-[15.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl animate-float-slow"
              style={{ animationDelay: '0.2s' }}
            >
              <MapIcon className="h-6 w-6 text-primary mb-3" />
              <h4 className="font-bold text-base text-white">Hyper-Local Grid</h4>
              <p className="text-[11px] text-text-muted mt-1 leading-snug">Scanning every coordinate within a 10km radius of your search location.</p>
            </div>
            
            {/* 2. Top Center (Overlapping the SVG) */}
            <div 
              className="takeover-hud-card absolute top-[15%] left-[42%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-5 w-full max-w-[15.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden md:block animate-float"
              style={{ animationDelay: '1.5s' }}
            >
              <Sparkles className="h-6 w-6 text-accent mb-3" />
              <h4 className="font-bold text-base text-white">AI Analysis</h4>
              <p className="text-[11px] text-text-muted mt-1 leading-snug">Cross-referencing reviews and unstructured data to extract insights.</p>
            </div>

            {/* 3. Middle Right */}
            <div 
              className="takeover-hud-card absolute top-[28%] right-[5%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-5 w-full max-w-[15.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden lg:block animate-float"
              style={{ animationDelay: '0.8s' }}
            >
              <Search className="h-6 w-6 text-primary mb-3" />
              <h4 className="font-bold text-base text-white">Smart Filtering</h4>
              <p className="text-[11px] text-text-muted mt-1 leading-snug">Instantly hiding spam, duplicates, and irrelevant businesses.</p>
            </div>
            ...
            >
              ...
              <p className="text-[11px] text-text-muted mt-1 leading-snug">Pulling the freshest data instantly without waiting for manual scrapes.</p>
            </div>

            {/* 5. Bottom Center */}
            <div 
              className="takeover-hud-card absolute bottom-[12%] left-[48%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-5 w-full max-w-[15.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden md:block animate-float-slow"
              style={{ animationDelay: '3.0s' }}
            >
              <Database className="h-6 w-6 text-primary mb-3" />
              <h4 className="font-bold text-base text-white">Deep Database</h4>
              <p className="text-[11px] text-text-muted mt-1 leading-snug">Accessing hidden public records and local registries Google Maps misses.</p>
            </div>

            {/* 6. Far Bottom Right */}
            <div 
              className="takeover-hud-card absolute bottom-[8%] left-[10%] md:bottom-[20%] md:left-[auto] md:right-[6%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-5 w-full max-w-[15.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl animate-float"
            ...
            <div 
              className="takeover-hud-card absolute bottom-[25%] left-[8%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-5 w-full max-w-[15.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden md:block animate-float-slow"
              style={{ animationDelay: '1.8s' }}
            >
              <Target className="h-6 w-6 text-accent mb-3" />
              <h4 className="font-bold text-base text-white">Lead Scoring</h4>
              <p className="text-[11px] text-text-muted mt-1 leading-snug">Prioritizing the highest value leads based on digital footprint gaps.</p>
            </div>
          </div>
        </section>
