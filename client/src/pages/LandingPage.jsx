      ...
      <div ref={mainRef} className="relative">
        ...
        <section ref={scrollTakeoverRef} className="relative h-screen w-full overflow-hidden flex items-center justify-center z-10 pt-16">
          ...
          <div className="absolute inset-0 pointer-events-none z-40">
            {/* 1. Top Left */}
            <div 
              className="takeover-hud-card absolute top-[22%] left-[5%] md:top-[28%] md:left-[6%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl animate-float-slow"
            ...
            <div 
              className="takeover-hud-card absolute top-[15%] left-[42%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden md:block animate-float"
            ...
            {/* 3. Middle Right */}
            <div 
              className="takeover-hud-card absolute top-[28%] right-[5%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden lg:block animate-float"
            ...
            <div 
              className="takeover-hud-card absolute top-[55%] right-[5%] md:top-[50%] md:left-[40%] md:right-[auto] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl animate-float-slow"
            ...
            {/* 5. Bottom Center */}
            <div 
              className="takeover-hud-card absolute bottom-[12%] left-[48%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden md:block animate-float-slow"
            ...
            {/* 6. Far Bottom Right */}
            <div 
              className="takeover-hud-card absolute bottom-[8%] left-[10%] md:bottom-[20%] md:left-[auto] md:right-[6%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl animate-float"
            ...
            <div 
              className="takeover-hud-card absolute bottom-[35%] right-[22%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden lg:block animate-float"
            ...
            <div 
              className="takeover-hud-card absolute bottom-[25%] left-[8%] card-base bg-surface/70 backdrop-blur-xl border-white/10 p-4 w-full max-w-[13.5rem] opacity-0 translate-y-10 will-change-transform rounded-2xl hidden md:block animate-float-slow"
              style={{ animationDelay: '1.8s' }}
            >
              <Target className="h-5 w-5 text-accent mb-2" />
              <h4 className="font-bold text-sm text-white">Lead Scoring</h4>
              <p className="text-[10px] text-text-muted mt-1 leading-snug">Prioritizing the highest value leads based on digital footprint gaps.</p>
            </div>
          </div>
        </section>
